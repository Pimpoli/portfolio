...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderAboutSection() {
    ...
    ul.appendChild(createItem('about.list.luauLabel',    'about.list.luauValue',    'Lenguaje principal:', 'Luau (Roblox) — dominio avanzado desde hace 4+ años',   false, 2));
    ul.appendChild(createItem('about.list.uiLabel',      'about.list.uiValue',      'UIs y animaciones:',  'Diseño de interfaces y animaciones fluidas para juegos',false, 3));
    ul.appendChild(createItem('about.list.systemsLabel', 'about.list.systemsValue', 'Sistemas propios:',   'Frameworks modulares reutilizables que agilizan el desarrollo', false, 4));
    ul.appendChild(createItem('about.list.enginesLabel', 'about.list.enginesValue', 'Motores que manejo:', 'Roblox Studio y Godot Engine 4',                       false, 5));
